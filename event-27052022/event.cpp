...
int main() //main function
{
	...
	cr = cd.ReadCarData("C:/Users/wangj/source/repos/cars/car1.txt");  //load car info
	bool deployFakeBeacon = true; //true = fake beacon scheme, false = mix-zone scheme
	
		...
		if (tempE.getEType() == carArrive)          //Process carArrive event
		{
			...
			if (eList.enteredMixZone(tempE.coorX, tempE.coorY, mp)) {
				...
				if (eList.enteringMixZone(tempE.coorX, tempE.coorY, mp)) { //if approaching a junction/mix-zone
					if (deployFakeBeacon) {  //deploy fake beacon algorithm
						...
						vector<RSUMsg> lastTenRSU; //last 10 RSUMsg from this car
						int whichId;
						for (int i = 10; i > 0; i--) {
							whichId = whichCar.size() - i - 1;
							lastTenRSU.push_back(whichCar[whichId]);
						}
						vector<beacon> possibleMeasurement = fb.possibleMeasurement(lastTenRSU, mp);
					}
				}
			}
		}
