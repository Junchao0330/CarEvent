...
struct probability 
{
	int endPseu; //pseudonym in last trace segment
	int startPseu; //pseudonym in next trace segment
	double prob; //probability of two trace segments belonging to the same car
};
